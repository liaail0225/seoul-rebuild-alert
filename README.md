...
## 설정 (1회)
1. Supabase SQL Editor에서 `scripts/setupDb.sql` 실행
...
3. 관심단지 시드: `node scripts/importExcel.js` (엑셀 → watchlist)
4. 봇 허용 사용자 등록: config 테이블 `allowed_chat_ids`에 chat_id 추가
